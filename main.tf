...
module "virtual_machines" {
  ...
  ansible_args             = format("--extra-vars '%#v' -e 'hostname=${var.name_prefix}-${count.index}' --extra-vars '${var.ansible_node_args}' -e purpose=${var.noamd_purpose} -vvv -b", local.ansible_extra_vars)
}
