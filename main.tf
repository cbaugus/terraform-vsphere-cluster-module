...
module "virtual_machines" {
  ...
  ansible_args             = format("--extra-vars '%#v' -e 'hostname=${var.name_prefix}-${count.index}' -e 'nomad_node_name=${var.name_prefix}-${count.index}' 'purpose=${var.name_prefix}' -e 'consul_acl_token=${var.consul_acl_token}' -e 'nomad_node_class=${var.nomad_node_class}' -e nomad_client_token='${var.nomad_consul_token}' -vvv -b", local.ansible_extra_vars)
}
